...
public class a1_Print_the_sum_of_the_integers_in_an_integer_array {
	...
	public static void main(String[] args) {
		...
		int arrSize = scanner.nextInt(); //e line array ntha size kavali ani.
		...
		//manam echina values ani array la print aavutai e line tho.
		System.out.println("Input : " + Arrays.toString(arr)); 
		
		/*
		 *  asal manam program enti array lo echina values ani sum chaiyali, aa sum chaiyatam kosam e 
		    for loop.
		 */
		int sum = 0;
