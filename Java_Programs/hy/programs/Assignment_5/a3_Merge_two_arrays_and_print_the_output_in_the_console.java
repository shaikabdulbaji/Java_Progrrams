...
public class a3_Merge_two_arrays_and_print_the_output_in_the_console {
	...
	public static void main(String[] args) {
		...
		//manaki 3rd array adi ela vachidi antea 1st array and 2nd array kalipitea vastadi.
		 ...
		 * edi kastha tricky ga untadi nduku antea 
		   ...
		   arr3[i] = arr2[i]; --> porabatuna ela echamu anuko manam 1st arry ni 3rd array loki insert 
